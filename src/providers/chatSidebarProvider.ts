...
export class ChatSidebarProvider implements vscode.WebviewViewProvider {
    ...
    private getModelDisplayName(model: string): string {
        const modelNames: { [key: string]: string } = {
            ...
            'openai/o4-mini-high-2025-04-16': 'O4 Mini High',
            'openai/o4-mini-2025-04-16': 'O4 Mini',
            'openai/gpt-4.5-preview-2025-02-27': 'GPT-4.5 Preview',
            'openai/o3-mini-high-2025-01-31': 'O3 Mini High',
            'openai/o3-mini-2025-01-31': 'O3 Mini',
            'openai/o1-pro': 'O1 Pro',
            'openai/gpt-4o-mini-search-preview-2025-03-11': 'GPT-4o Mini Search',
            'openai/gpt-4o-search-preview-2025-03-11': 'GPT-4o Search',
            'openai/o1-2024-12-17': 'O1 (Dec 2024)',
            ...
            'anthropic/claude-4-opus-20250522': 'Claude 4 Opus',
